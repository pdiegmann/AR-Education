...
'Increased Concentration' is about the amount of concentration while using \AR \apps. This benefit was also found for three times. Similar to the detailed description of \cite{Iwata.2011} for increased motivation through \AR \app, "physical interaction
...
manual way\autocite[448]{Hou.2013}. Additionally this benefit was mentioned by \cite{Ibanez.2014} and \cite{Redondo.2013}, so in total 5 times.
...
The benefit 'Increased Interactivity' could be seen as a precondition for other benefits presented in this paper, which it is, as you can see in the following. Anyway, increased interactivity through the application of \AR is a 
fact which is not recognised by application of the corresponding conventional method\autocite[113]{Dunser.2012}\mulcit\autocite[11]{Ibanez.2014} and therefore specyfied as a single benefit.
...
Together this can contribute to a deeper understanding. Interactions in AR engage learners with the content, and allow for knowledge to be acquired through their own manipulation of content (Dünser, 2008), 
as supported by constructivist learning theory (Tobias & Duffy, 2009 )."
...
'Improved Memory' refers to the retention of what was learned during the application of the \AR-method. \cite{Hou.2013} states that "trainees with AR training could remember or recollect more assembly 
...
AR technology, and helping visitors keep their memories of the artwork vivid"\autocite[193]{Chang.2014}. Also \cite{Macchiarella.2004} says that \AR "lead[s] to an increased ability to retain long term memories".
This benefit was mentioned 3 times in total.
